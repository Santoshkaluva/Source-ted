...
var akhil = window.akhil || {};
			...
			// The scrolling to top Button

			$('.gotop').click(function(arg){
			arg.preventDefault();
			...
			// Menu button at the top of the navbar

			$('#registerToggle, .register-close').on('click', function(){
				$('#registerToggle').toggleClass('active');
				$('body').toggleClass('goleft');
				$('header').toggleClass('goleft');
				$('#register-menu').toggleClass('register-open');
			});	
